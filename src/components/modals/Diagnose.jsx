...
const Diagnose = ({ visible, onClose }) => {
  ...
  return (
    ...
    <div className="modal-container bg-white w-96 rounded-lg shadow-lg z-50 relative">
      ...
      <div className="modal-content p-4">
        ...
        <label className='block'>Diagnose</label>
        <textarea className="bg-[#ccd6f6] p-2  focus:outline-none  text-black" placeholder='Enter diagnosis here.' cols='35' rows='2'/>
      </div>
