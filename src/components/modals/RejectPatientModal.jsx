...
const RejectPatientModal = ({ visible, onClose }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="modal-container bg-white w-96 rounded-lg shadow-lg z-50 relative">
        ...
        <div className="modal-header bg-[#4867D6] text-white p-4 rounded-t-lg">
          <h2 className="text-2xl font-semibold">Reject Appointment</h2>
        </div>
        <div className="modal-content p-4">
          {/* Your modal content goes here */}
          <label className='block'>Reason</label>
          <textarea className="bg-[#ccd6f6] p-2  focus:outline-none  text-black" placeholder='Enter a reason for rejecting the appointment.' cols='35' rows='2'/>
        </div>
...
export default RejectPatientModal;
